...
$scope.aboutme_summaryCard=function(chickletData,sectionName,chickletName,chicklets){
$mdDialog.show({
      templateUrl:'/views/aboutme_summary_modal.html',
...
$scope.institutionModal=function(chickletData,sectionName,chickletName,chicklets){
$mdDialog.show({
...
$scope.projectModal=function(chickletData,sectionName,chickletName,chicklets){
$mdDialog.show({
